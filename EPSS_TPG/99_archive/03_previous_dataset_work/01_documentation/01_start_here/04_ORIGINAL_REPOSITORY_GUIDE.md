...
Historical repository guide, preserved during the numbered-folder reorganization. Start with [the current documentation index](../../../../00_documentation/README.md) and [folder map](../07_maintenance/01_LAYOUT_AND_COMPATIBILITY.md). Commands below use compatibility paths from the original layout.
