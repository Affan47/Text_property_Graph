...
**Date:** 2026-04-30
**Goal:** Confirm or reject the hypothesis (raised by [TPG_ablation/tpg_ablation_results.md](../06_graph_ablation/tpg_ablation_results.md)) that the **CVSS components are the dominant remaining target proxy** in the tabular branch.
...
A direct read of [tabular_features.py:196-203](../../../../../02_prediction/01_package/epss/tabular_features.py) reveals the answer:
...
[`epss/run_pipeline.py:115`](../../../../../02_prediction/01_package/epss/run_pipeline.py#L115):
```python
parser.add_argument("--no-epss-feature", action="store_true",
                    help="...")
```

[`epss/run_pipeline.py:218`](../../../../../02_prediction/01_package/epss/run_pipeline.py#L218):
```python
