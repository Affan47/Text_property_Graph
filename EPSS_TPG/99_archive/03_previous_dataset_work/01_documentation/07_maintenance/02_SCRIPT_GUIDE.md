...
Then inspect the four existing examples in `01_tpg/02_examples/02_graphson/` alongside [their explanation](../../../../00_documentation/02_tpg/04_GRAPH_EXAMPLES.md). The simple `demo.py` executes immediately; read it before running it. `compare_frontends.py` compares frontend choices.
...
The [code guide](../../../../00_documentation/01_start_here/02_CODE_READING_ORDER.md) follows the remaining stages in order.
