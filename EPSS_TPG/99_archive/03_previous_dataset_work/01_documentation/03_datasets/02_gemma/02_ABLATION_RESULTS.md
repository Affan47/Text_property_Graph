...
All commands assume working directory `EPSS_TPG`. The full 8-run command sequence is in [README.md §6](01_README.md#6-reproduction-commands). For each run, the prepare step produces a uniquely-suffixed `*_prepared.csv` that the train step consumes.
