...
| **Profile artefacts** | [profile.json](../../../02_dataset_analysis/04_deepseek/profile.json), [profile.txt](03_PROFILE.txt) |
...
| **Overall synthesis** | [../OVERALL_ANALYSIS.md](../../../02_dataset_analysis/OVERALL_ANALYSIS.md) — 32-run synthesis across all 4 datasets |
...
| Path | Purpose |
|---|---|
| [profile.json](../../../02_dataset_analysis/04_deepseek/profile.json) | Machine-readable feature/distribution profile |
