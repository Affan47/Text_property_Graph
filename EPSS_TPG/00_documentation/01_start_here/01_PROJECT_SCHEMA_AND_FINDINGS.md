...
The folder table above describes the pre-reorganization names, retained as compatibility links. Use [Start Here](../README.md) for canonical numbered paths and the current reading order.
...
Artifacts: [TPG_examples](../02_tpg/04_GRAPH_EXAMPLES.md).
...
Sources: [tpg_app/engine.py](../../01_tpg/03_application/tpg_app/engine.py), [tpg_app/store.py](../../01_tpg/03_application/tpg_app/store.py), [tpg_app/README.md](../02_tpg/05_APPLICATION_GUIDE.md).
