...
are in [results.md](02_RESULTS.md). Headline:
...
Before training, [`epss/security_edges_stats.py`](../../../02_prediction/01_package/epss/security_edges_stats.py) was run on the full 9,218-CVE corpus to measure how often each SEC_* edge type fires. Full output: [security_edges_stats/gpt_combined_full.json](../../../05_results/03_dataset_analysis/05_summary_ablation/security_edges_stats/gpt_combined_full.json).
...
Detailed per-run metrics are in [results.md](02_RESULTS.md).
