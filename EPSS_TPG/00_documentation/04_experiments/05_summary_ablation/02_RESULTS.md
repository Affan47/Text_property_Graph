...
| Path | What's in it |
|---|---|
| [all_runs_aggregate.json](../../../05_results/03_dataset_analysis/05_summary_ablation/all_runs_aggregate.json) | Older aggregate artefact; not regenerated for the 2026-05-04 rerun |
...
This is the experiment §8 recommended as the highest-leverage open question. Implemented in [`epss/cross_distribution_eval.py`](../../../02_prediction/01_package/epss/cross_distribution_eval.py).
...
Read from [`output/cross_eval/gpt_B_on_nvd_full/cross_distribution_results.json`](../../../01_tpg/02_examples/03_generated/cross_eval/gpt_B_on_nvd_full/cross_distribution_results.json):
