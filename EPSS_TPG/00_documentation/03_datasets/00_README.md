...
For NVD/KEV and current MegaVul label behavior, read the current project findings and the adapter/collector files listed in the [code guide](../01_start_here/02_CODE_READING_ORDER.md). For manuscript tables, see [dataset_features.tex](../06_papers/01_sources/dataset_features.tex).
