...
| **Profile artefacts** | [profile.json](../../../05_results/03_dataset_analysis/01_gpt/profile.json), [profile.txt](03_PROFILE.txt) |
| **Ablation results** | [ablation_results.md](02_ABLATION_RESULTS.md) — A/B/C/D comparison of dedupe + drop-summary flags |
...
**Update (2026-04-28 — see [ablation_results.md](02_ABLATION_RESULTS.md)):**
...
| Path | Purpose |
|---|---|
| [profile.json](../../../05_results/03_dataset_analysis/01_gpt/profile.json) | Machine-readable feature/distribution profile |
...
|---|---|---|
| 8-flag ablation matrix (Runs A-H) | Original ablation programme — preserved as the no-summary, EPSS-leak-on baseline | [ablation_results.md](02_ABLATION_RESULTS.md) |
| TPG-isolation (T1-T7) | Drops `--hybrid` → no tabular branch, no EPSS leak; isolates the TPG-only ceiling | [../TPG_ablation/tpg_ablation_results.md](../../04_experiments/06_graph_ablation/tpg_ablation_results.md) |
| CVSS-isolation (CV1-CV4) | Drops the 10 CVSS columns; revealed the actual leak source via process of elimination | [../CVSS_ablation/cvss_ablation_results.md](../../04_experiments/07_cvss_ablation/cvss_ablation_results.md) |
| **Summary-in-TPG (16 new runs per dataset)** | New `--include-summary-in-tpg` flag finally feeds the LLM summary to TPG; combined with `--no-epss-feature` for production-honest evaluation | [../Summary_in_TPG_ablation/README.md §4.1](../../04_experiments/05_summary_ablation/01_README.md#41-gpt-dataset-gpt_combined_summ) |
