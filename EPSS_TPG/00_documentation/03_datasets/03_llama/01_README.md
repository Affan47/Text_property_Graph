...
| **Profile artefacts** | [profile.json](../../../05_results/03_dataset_analysis/03_llama/profile.json), [profile.txt](03_PROFILE.txt) |
| **Sister datasets** | [gpt_combined_summ](../01_gpt/01_README.md), [gemma_combined_summ](../02_gemma/01_README.md) — same row corpus, different LLM summarizer |
| **Ablation results** | [ablation_results.md](02_ABLATION_RESULTS.md) — 8-run sweep + 3-way GPT vs Gemma vs Llama comparison |
...
All non-summary columns are identical to gpt/gemma. See [gpt_combined_summ §1](../01_gpt/01_README.md#1-features-27-columns) for the full per-column documentation. The differences are:
...
| Path | Purpose |
|---|---|
| [profile.json](../../../05_results/03_dataset_analysis/03_llama/profile.json) | Machine-readable feature/distribution profile |
...
| `ablation_results.md` | Will be created after the 8 runs finish, mirroring the [gpt](../01_gpt/02_ABLATION_RESULTS.md) and [gemma](../02_gemma/02_ABLATION_RESULTS.md) analyses |
