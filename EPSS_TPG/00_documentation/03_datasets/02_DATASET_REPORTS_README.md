...
For the project-level entry point, see [../README.md](../01_start_here/03_RUNNING_THE_PROJECT.md).
...
current canonical dataset is the [`SummTPGVul`](../../04_data/02_source_repository) submodule
...
- [Per_LLM_profile_new/per_llm_full_profile.csv](../../05_results/03_dataset_analysis/10_full_profiles/per_llm_full_profile.csv) — per-(LLM, variant) graph + SEC_* overlay stats for the current 15-run baseline
- [Summary_in_TPG_ablation/results.md](../04_experiments/05_summary_ablation/02_RESULTS.md) — summary-in-TPG ablation results
